...
// #[cfg(feature = "3d")]
mod dim {
    pub(crate) use super::dim3::{queue_debug_lines, DebugLinePipeline, DrawDebugLines};
...
//     pub(crate) use super::dim2::{queue_debug_lines, DebugLinePipeline, DrawDebugLines};
...
#[derive(Component)]
pub struct RenderDebugLinesMesh;
